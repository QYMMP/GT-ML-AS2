...
def main(population, toMate, toMutate):
    """Run this experiment"""
    ...
    oa_name = "GA_{}_{}_{}".format(population, toMate, toMutate)
    ...
    oa = StandardGeneticAlgorithm(population, toMate, toMutate, nnop)
...
if __name__ == "__main__":
    population = 50
    for toMate, toMutate in product([20, 10], [20, 10]):
        main(population, toMate, toMutate)
